  ...
  <div class="pt-8">
    ...
    <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
      ...
      <div class="w-full md:w-3/5 py-6 text-center">
        <img class="w-full md:w-4/5 z-50 select-none" :src="hero_img">
      </div>

    </div>


	<div class="hidden relative -mt-12 lg:-mt-24">
...
export default {
  ...
  data(){
    return{
      hero_img: "https://www.tailwindtoolbox.com/templates/hero.png",
      title: "",
      subtitles: []
    }
  },
